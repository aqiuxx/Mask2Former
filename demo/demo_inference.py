...
def get_parser():
    ...
    # --input /Users/aqiu/Documents/1_study/00_AllMyXX/AllMyDataset/NuScenes/v1.0-mini/samples/CAM_FRONT \
    # --output /Users/aqiu/Documents/1_study/00_AllMyXX/AllMyDataset/NuScenes/v1.0-mini/samples/SEG_CAM_FRONT \
    ...
    parser.add_argument(
        "--base_dir",
        default="/Users/aqiu/Documents/1_study/00_AllMyXX/AllMyDataset/NuScenes/v1.0-mini/samples/",  # "samples" contain key frames
        help="nuScenes base dir",
    )

    parser.add_argument(
        "--save_dir",
        default="/Users/aqiu/Documents/1_study/00_AllMyXX/AllMyDataset/NuScenes/v1.0-mini/samples/",
        help="nuScenes base dir",
    )
    parser.add_argument(
        "--vis_dir",
    ...
    parser.add_argument(
        ...
        default=["MODEL.DEVICE", "cpu", "MODEL.WEIGHTS", "configs/mapillary-vistas/model_final_90ee2d.pkl"],
...
if __name__ == "__main__":
    ...
    args.save_dir = args.base_dir + "seg_"
    args.vis_dir = args.base_dir + "vis_seg_"
    label_save_paths = [file_path.replace(args.base_dir, args.save_dir) for file_path in file_paths]
    vis_label_save_paths = [file_path.replace(args.base_dir, args.vis_dir) for file_path in file_paths]
